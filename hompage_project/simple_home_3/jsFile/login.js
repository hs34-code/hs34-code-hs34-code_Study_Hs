...
loginForm.addEventListener("submit", (e) => {
  e.preventDefault();
  const loginEmail = document.querySelector(".login-form #email").value;
  const loginPassword = document.querySelector(".login-form #password").value;
...
btnFindEmail.addEventListener("submit", (e) => {
  ...
  const inputName = document.querySelector(".findEmail-form #findEmailName").value;
  const inputPhone = document.querySelector(".findEmail-form #findEmailNumber").value;
  const inputDob = document.querySelector(".findEmail-form #findEmailDob").value;
...
btnFindPassword.addEventListener("submit", (e) => {
  ...
  const inputName = document.querySelector(".findPassword-form #findPasswordName").value;
  const inputPhone = document.querySelector(".findPassword-form #findPasswordNumber").value;
  const inputEmail = document.querySelector(".findPassword-form #findPasswordEmail").value;
