...
btnFindEmail.addEventListener("submit", (e) => {
  ...
  const inputName = document.querySelector(".login-form #findEmailName").value;
  const inputPhone = document.querySelector(".login-form #findEmailNumber").value;
  const inputDob = document.querySelector(".login-form #findEmailDob").value;
...
btnFindPassword.addEventListener("submit", (e) => {
  ...
  const inputName = document.querySelector(".login-form #findPasswordName").value;
  const inputPhone = document.querySelector(".login-form #findPasswordNumber").value;
  const inputEmail = document.querySelector(".login-form #findPasswordEmail").value;
